    ...
    const verify = async () => {
      try {
        ...
        if (res.ok) {
          ...
          setStatus('success');
          // Redireciona para o app apÃ³s 2 segundos
      ...
      <div className="glass p-12 max-w-md w-full text-center space-y-6">
        ...
        {status === 'error' && (
          <>
            ...
            <h1 className="text-2xl font-bold text-red-500">Link InvÃ¡lido</h1>
            <p className="text-gray-500">Este link expirou ou jÃ¡ foi utilizado. Solicite um novo link de acesso.</p>
            <button 

      ...
      <section className="py-40 px-6 bg-black relative">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-24 items-center">
          <motion.div {...fadeInUp} className="space-y-10">
            <motion.h2 className="text-5xl md:text-7xl font-bold tracking-tighter">Sua noite <br/>pertence a você.</motion.h2>
            <motion.p className="text-2xl text-zinc-500 leading-tight">

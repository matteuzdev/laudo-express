...
export default function LandingPage() {
  ...
  return (
    <div className="bg-black text-white selection:bg-white selection:text-black min-h-screen font-sans overflow-x-hidden">
      ...
      {/* --- 1. HERO SECTION (ESTILO LINEAR COM LAMP E SPOTLIGHT) --- */}
      <section className="relative min-h-screen flex flex-col justify-center items-center text-center p-6 pt-32 overflow-hidden">
        ...
        <motion.div 
          ...
          className="mt-32 relative w-full max-w-6xl aspect-[21/9] rounded-[3rem] border border-white/10 bg-zinc-900 overflow-hidden shadow-[0_0_120px_rgba(255,255,255,0.05)] group"
        >
          <img 
            src="https://images.unsplash.com/photo-1512917774080-9991f1c4c750?auto=format&fit=crop&q=80&w=1200" 
            alt="Inspectify Interface" 
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-24 items-center">
          <motion.div {...fadeInUp} className="space-y-10">
            ...
            <p className="text-2xl text-zinc-500 leading-tight">
              Chega de chegar em casa exausto e ter que encarar o computador. 
      ...
      <section id="features" className="py-48 px-6">
        <div className="max-w-7xl mx-auto space-y-32">
          <div className="text-center space-y-6">
            ...
            <p className="text-zinc-500 text-2xl font-medium">Ferramentas desenhadas para quem está no trecho.</p>
          </div>
          
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {/* Bento Card 1 */}
            <div className="md:col-span-2 p-16 border border-white/5 bg-zinc-950 rounded-[3rem] flex flex-col justify-between group hover:border-white/20 transition-all overflow-hidden relative">
      ...
      {/* --- 5. PLANOS (PRICING ELITE) --- */}
      <section id="pricing" className="py-48 px-6 bg-zinc-950/50 border-y border-white/5 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto space-y-32 z-10 relative">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {plans.map((p) => (
              <div key={p.nome} className={`relative p-12 border rounded-[3rem] flex flex-col justify-between transition-all duration-500 ${p.popular ? 'border-white/30 bg-white/[0.07] scale-105 shadow-[0_0_80px_rgba(255,255,255,0.05)]' : 'border-white/5 bg-black'}`}>
                ...
                <div className="w-full pt-16">
                  {p.popular ? (
                    <Link href="/login" className="w-full block">
                      <ShimmerButton className="w-full">ASSINAR AGORA</ShimmerButton>
                    </Link>
                  ) : (
                    <Link href="/login" className="w-full block">
                      <button className="w-full py-6 rounded-2xl font-black text-xl transition-all border border-white/10 bg-white/5 hover:bg-white/10">
                        ASSINAR AGORA
                      </button>
                    </Link>
                  )}

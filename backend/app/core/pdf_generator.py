...
class LaudoGenerator:
    ...
    def generate(self, dados_vistoria: dict, fotos: list):
        ...
        titulo = Paragraph(f"<b>LAUDO DE VISTORIA IMOBILIÁRIA</b>", self.styles['Title'])
        story.append(titulo)
        story.append(Spacer(1, 12))

        # 2. Informações da Propriedade
        info_data = [
            [f"Imóvel:", dados_vistoria['endereco']],
        ...
        # 3. Fotos e Observações por Cômodo
        comodos = {}
        for foto in fotos:
        ...
        for comodo, lista_fotos in comodos.items():
            story.append(Paragraph(f"<b>CÔMODO: {comodo.upper()}</b>", self.styles['Heading2']))
...
# Exemplo de uso rápido para teste do bando
if __name__ == "__main__":
    generator = LaudoGenerator("exemplo_laudo.pdf")
    dados = {
        "endereco": "Rua das Flores, 123 - Centro",
        "cliente": "Imobiliária Sertão Verde",
        "data": "18/03/2026",
        "inspetor": "Soberano Hianto"
    }
    # Simulando fotos (precisaria de arquivos reais para testar o binário)
    fotos = [
    ...
    # generator.generate(dados, fotos) # Descomentar após ter fotos reais no diretório
